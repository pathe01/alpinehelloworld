...
pipeline {
    environment {
       ...
       //ID_DOCKER = "${PARAM_ID_DOCKER}"
        ...
        STG_API_ENDPOINT = "192.168.56.14:1993"        /* Mettre le couple IP:PORT de votre API eazylabs, exemple 100.25.147.76:1993 */
        STG_APP_ENDPOINT = "192.168.56.14:8000"        /* Mettre le couple IP:PORT votre application en staging, exemple 100.25.147.76:8000 */
        PROD_API_ENDPOINT = "192.168.56.14:1993"       /* Mettre le couple IP:PORT de votre API eazylabs, 100.25.147.76:1993 */
        PROD_APP_ENDPOINT = "192.168.56.14"            /* Mettre le couple IP:PORT votre application en production, exemple 100.25.147.76 */
